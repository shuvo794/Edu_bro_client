...
const Header = () => {
  const { userLogOut, user, toggle, setToggle, handleClick, admin } =
    useFirebase();
      ...
      <Navbar expand="lg">
        <Container>
          ...
          <Navbar.Collapse id="basic-navbar-nav">
            <Nav
              onClick={handleClick}
              className="ms-auto menu d-flex align-items-center"
            >
              <Nav.Link as={NavLink} to="/questions" className="menu-item">
                Questions
              </Nav.Link>
              <Nav.Link as={NavLink} to="/assignments" className="menu-item">
                Assignments
              </Nav.Link>
              <NavDropdown
                className="me-3 menu-item"
                title="More"
                id="navbarScrollingDropdown"
              >
                <NavDropdown.Item as={NavLink} to="/syllabus">
                  Syllabus
                </NavDropdown.Item>
                ...
                <NavDropdown.Item as={NavLink} to="/labs">
                  Labs
                </NavDropdown.Item>
